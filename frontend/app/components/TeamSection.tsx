  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center justify-center pt-20 pb-12 px-4 border-b border-border">
        ...
        <p className="mt-3 text-sm font-medium tracking-[0.15em] text-muted-foreground">
      ...
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-2">
        ...
        >
          <p className="text-xs font-bold tracking-[0.3em] text-primary mb-6">
          ...
          <div className="space-y-4 mb-10 text-muted-foreground text-base sm:text-lg leading-relaxed max-w-2xl">
        ...
        >
          <p className="text-xs font-bold tracking-[0.3em] text-primary mb-12 self-start lg:self-auto">
          ...
          <div className="flex flex-wrap justify-center gap-8 lg:gap-12 max-w-2xl">
            {TEAM.map(({ id, nameKey, roleKey, imgSrc, gradient, socials }) => (
              <div
                key={id}
                className="flex w-32 cursor-default flex-col items-center gap-4 text-center"
              >
                <div
                  className={`triage-card h-28 w-28 rounded-full bg-gradient-to-br ${gradient} p-1`}
                >
                ...
                <div className="flex flex-col items-center gap-1.5 w-full mt-2">
                  <div className="text-base font-semibold text-foreground/90 leading-tight">
